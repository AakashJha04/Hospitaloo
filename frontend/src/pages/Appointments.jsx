...
import verified_img from '../assets/assets_frontend/verified_icon.svg'
...
const Appointments = () => {
  ...
  const daysOfWeeks = ['SUN', 'MON', 'TUE', 'WED', 'THURS', 'FRI', 'SAT'];
    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <img className='w-5' src={verified_img}/>
          </p>
      ...
      <div className='flex items-center gap-3 w-full overflow-x-scroll mt-4'>
        ...
        {docSlots.length && docSlots[slotIndex].map((item, index)=>(
          <p onClick={()=> setSlotTime(item.time)} className={`text-sm font-light fkex-shrink-0 px-5 py-2 rounded-full cursor-pointer ${item.time === slotTime ? 'bg-primary text-white': 'text-gray-400 border border-gray-300'}`} key={index}>
